...
export function TestSteps() {
    return (
        <div
            className="rounded-[12px] absolute top-[112px] w-full max-w-lg md:max-w-sm bg-white/50 p-6 text-white flex flex-col"
        ...
        >
            ...
            <div className="custom-scrollbar overflow-y-auto pr-2" style={{ maxHeight: "450px" }}>
                {[...Array(10)].map((_, index) => (
                    <div key={index} className="grow shrink basis-0 mt-3 text-black/50 text-[15px] font-normal font-['Inter'] leading-tight text-start flex">
                ...
                <div>
                    <div
                         className="grow shrink basis-0 mt-3 text-black/50 text-[15px] font-normal font-['Inter'] leading-tight text-start flex">
                        <span className="mr-auto">#ID'li buton tıklanıldı</span>
                        <div className="relative ml-auto">
                            <FailCheckIcon/>
                        </div>
