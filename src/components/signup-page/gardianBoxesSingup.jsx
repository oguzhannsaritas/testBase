export function GradientBoxesSignup() {
    return (
        <div className=" lg:flex flex-col absolute right-3/4 top-28 space-y-6  ">
            ...
            <div
                className="w-[474px] min-w-[280px] h-[329px] bg-gradient-to-b from-white/60 to-white/50 shadow-lg backdrop-blur-md rounded-[10px] flex flex-col items-center p-[19px] border border-gray-300">
                <img
                    src="/world.png"
                    alt="World Image"
